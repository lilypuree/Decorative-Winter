//package com.lilypuree.decorative_winter.client.particles;
//
...
//
//
//    private GoldParticle(ClientWorld worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeedIn, double speedIn) {
