...
public class VertexFormatElement {
    ...
    public static enum Usage {
        POSITION("Position", (size, type, stride, pointer, p_227914_5_) -> {
            GlStateManager.vertexPointer(size, type, stride, pointer);
            GlStateManager.enableClientState(32884);
        }, (p_227912_0_) -> {
            GlStateManager.disableClientState(32884);
        }),
        NORMAL("Normal", (p_227913_0_, type, stride, pointer, p_227913_5_) -> {
            GlStateManager.normalPointer(type, stride, pointer);
            GlStateManager.enableClientState(32885);
        }, (p_227910_0_) -> {
            GlStateManager.disableClientState(32885);
        }),
        COLOR("Vertex Color", (size, type, stride, pointer, p_227911_5_) -> {
            GlStateManager.colorPointer(size, type, stride, pointer);
            GlStateManager.enableClientState(32886);
        }, (p_227908_0_) -> {
            GlStateManager.disableClientState(32886);
            GlStateManager.clearCurrentColor();
        }),
        UV("UV", (size, type, stride, pointer, texture) -> {
            GlStateManager.clientActiveTexture('\u84c0' + texture);
